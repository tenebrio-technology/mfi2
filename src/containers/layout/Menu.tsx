...
export const Menu = () => 
  <Navbar expand="sm" className="navbar-vertical d-none d-sm-block">
    ...
    <Nav className="pt-3 px-3">
      <Nav.Link><FontAwesomeIcon className="pe-2" icon={faMapLocationDot}/>Locations</Nav.Link>
      <Nav.Link><FontAwesomeIcon className="pe-2" icon={faLayerGroup} />Habitats</Nav.Link>
    </Nav>
    </Navbar.Collapse>
  </Navbar>;